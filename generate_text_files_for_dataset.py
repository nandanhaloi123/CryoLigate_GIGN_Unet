...
def main(complex_name, db_path):
    ...
    txt_path = os.path.join(complex_folder, f"{complex_name}_complexes_temporary_bad_maps_only.txt")

    # with open(txt_path, "w") as file:
    #     file.write(os.path.join(complex_folder, f"{complex_name}_5A.rdkit"))

    with open(txt_path, "w") as file: # NOTE TODO: change this to original complexes
        file.write(os.path.join(complex_folder, f"184l_5A.rdkit"))
...
if __name__ == '__main__':
    ...
    db_path = '/proj/berzelius-2022-haloi/users/x_elima/PDBBind_Zenodo_6408497'
    # load molecule names
    complex_names_csv = (
