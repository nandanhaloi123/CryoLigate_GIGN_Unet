...
if __name__ == "__main__":
    ...
    #         db_path,
    #         complex_name,
    #         f"{complex_name}_nconfs{n_confs}_genmode_{generation_mode}_boxextens{box_extension}_res{density_resolution}_nbox{n_box}_gridspacing{grid_spacing}_threshcorr{threshold_correlation}_delprob{delete_prob}_low_resolution_forward_model.mrc",
    #     )
    ...
    complex_names = complex_names[start_index : (end_index + 1)]
    complex_names = [
        "4mt9", "4no9", "4mk5", "4od7", "4nh9", "4nwd", "4m3q",
        "4mq1", "4mww", "4ly1", "4n4t", "4mao", "4lqy", "4mg5",
        "4oar", "4o55", "4oaz", "4mn3", "4o3a", "4pd5", "4pd6",
        "4pd7", "4pd8", "4pd9", "4pda", "4p7m", "4p7s", "4pb1",
        "4pb2", "4n07", "4psh", "4rgd", "4tqn", "4rt0", "4u5t",
        "4v1f", "4rt1", "4us3", "4us4", "4w4z", "4w50", "4xqa",
        "5a3o", "4z7f", "4x3t", "5ai5", "5bqs", "5ar7", "5acx",
        "5akk", "5db1", "5c1w", "5cxi", "5alu", "5cr7", "5aom",
        "5d3h", "5ceo", "5dhp", "5a81", "5a46", "5b1s", "5c7d",
        "5dbm", "5apr", "5c11", "5c13", "5azf", "5ep7", "5eng", 
        "5eq0", "5i83", "5i86", "5i89", "5ien", "5iep", "5h85",
        "5h8x", "5jr2", "5ktu", "5ktw", "5ktx", "5lpj", "5lpk",
        "5lpl", "5lpm", "5mpk", "5mpn", "5mpz", "5mqe", "5lso",
        "5m29", "5may", "5mb1", "5mme", "5mmg", "5aer", "5m2q",
        "5mts", "5m34", "5j0d", "5m3b"
    ]
    n_complexes = len(complex_names)
    print(f"Computing low resolution density maps for {n_complexes} complexes....")
