...
u'At': ((0.458824, 0.309804, 0.270588), 1, u'default'), u'In': ((0.65098, 0.458824, 0.45098), 1, u'default')}
	...
	viewerInfo = {'cameraAttrs': {'center': (35.319500004768, 35.108999995232, 70.149000011921), 'fieldOfView': 48.655426633719, 'nearFar': (48.468460205858, 33.684547328803), 'ortho': False, 'eyeSeparation': 50.8, 'focal': 70.149000011921}, 'viewerAttrs': {'silhouetteColor': None, 'clipping': False, 'showSilhouette': False, 'showShadows': False, 'viewSize': 10.371356139318, 'labelsOnTop': True, 'depthCueRange': (0.5, 1), 'silhouetteWidth': 2, 'singleLayerTransparency': True, 'shadowTextureSize': 2048, 'backgroundImage': [None, 1, 2, 1, 0, 0], 'backgroundGradient': [('Chimera default', [(1, 1, 1, 1), (0, 0, 1, 1)], 1), 1, 0, 0], 'depthCue': True, 'highlight': 0, 'scaleFactor': 1.3674746570244, 'angleDependentTransparency': True, 'backgroundMethod': 0}, 'viewerHL': 5, 'cameraMode': 'mono', 'detail': 1.5, 'viewerFog': None, 'viewerBG': None}
      ...
      [
       {
        ...
        'session_volume_id': 'r[]{}U:y4\r)<ZYE[fK\x0bB{GXvK}%Vptcn',
        ...
        'surface_levels': [ 0.006285899394912682, ],
        'surface_model': {
          'active': True,
          'class': 'Model_State',
          ...
          'xform': {
            'class': 'Xform_State',
            'rotation_angle': 56.604160406366795,
            'rotation_axis': ( 0.793517705642843, -0.6056485456046267, -0.059325290039905255, ),
            'translation': ( 50.0548330257353, 58.45105868639355, -38.765911490459196, ),
            'version': 1,
           },
         },
      ...
      [
       {
        ...
        'representation': 'surface',
        'session_volume_id': '2PtcRa*~6$t*.JAzn{8,8QZ1"Qf;cSzn',
        'solid_brightness_factor': 1.0,
        'solid_colors': [
          ( 1, 1, 0.7, 1, ),
          ( 1, 1, 0.7, 1, ),
        ...
        'surface_levels': [ 0.0017919581126689967, ],
        'surface_model': {
          'active': True,
          'class': 'Model_State',
          'clip_plane_normal': ( 0.0, 0.0, 0.0, ),
          ...
          'xform': {
            'class': 'Xform_State',
            'rotation_angle': 57.07087574763583,
            'rotation_axis': ( 0.796613655383381, -0.601135397313692, -0.06358394571932105, ),
            'translation': ( 50.07860249645661, 59.21571229957649, -38.467264632867625, ),
            'version': 1,
           },
         },
        'transparency_depth': 0.5,
      ...
      [
       {
        ...
        'representation': 'surface',
        'session_volume_id': '=3w!SPw8?8hjEXsJQcN"Nt|{eMU/1+CR',
        'solid_brightness_factor': 1.0,
        'solid_colors': [
          ( 0.7, 1, 1, 1, ),
          ( 0.7, 1, 1, 1, ),
        ...
        'surface_levels': [ 0.0016072441962764151, ],
        'surface_model': {
          'active': True,
          'class': 'Model_State',
          'clip_plane_normal': ( 0.0, 0.0, 0.0, ),
          ...
          'xform': {
            'class': 'Xform_State',
            'rotation_angle': 56.39554609637608,
            'rotation_axis': ( 0.8066471686909839, -0.5910330891393131, -0.00048247824856408316, ),
            'translation': ( 35.0239485395038, 31.055479784515857, 21.38227139419824, ),
            'version': 1,
           },
         },
        'transparency_depth': 0.5,
      ...
      [
       {
        ...
        'surface_levels': [ 0.049356479662019816, ],
        'surface_model': {
          'active': True,
          'class': 'Model_State',
          'clip_plane_normal': ( 0.0, 0.0, 0.0, ),
          ...
          'xform': {
            'class': 'Xform_State',
            'rotation_angle': 55.549335641046476,
            'rotation_axis': ( 0.797055062776826, -0.6039048111571663, 0.0014852484833060777, ),
            'translation': ( 35.12858020581742, 30.69596783171028, 21.261083382375556, ),
            'version': 1,
           },
         },
        'transparency_depth': 0.5,
 ...
 volume_dialog_state = \
  {
   ...
   'data_cache_size': '512',
   'focus_volume': 'r[]{}U:y4\r)<ZYE[fK\x0bB{GXvK}%Vptcn',
   'geometry': u'671x383+2562+266',
   'histogram_active_order': [ 2, 0, 1, ],
   'histogram_volumes': [ ']dQR~I_ci2\n;hw$]r/&n9c3*Y4t?KF6X', '=3w!SPw8?8hjEXsJQcN"Nt|{eMU/1+CR', 'r[]{}U:y4\r)<ZYE[fK\x0bB{GXvK}%Vptcn', ],
...
def restoreRemainder():
	...
	xformMap = {0: (((0.8065652382991, -0.59114131666979, 0.0021118933270726), 55.933865423223), (48.659936526081, 57.902136017846, -38.978719481496), True)}
