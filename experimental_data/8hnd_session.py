...
u'At': ((0.458824, 0.309804, 0.270588), 1, u'default'), u'In': ((0.65098, 0.458824, 0.45098), 1, u'default')}
	...
	viewerInfo = {'cameraAttrs': {'center': (66.853499980927, 72.116, 70.4685), 'fieldOfView': 48.655426633719, 'nearFar': (49.797509512452, 33.126247883355), 'ortho': False, 'eyeSeparation': 50.8, 'focal': 70.4685}, 'viewerAttrs': {'silhouetteColor': None, 'clipping': False, 'showSilhouette': False, 'showShadows': False, 'viewSize': 13.282354612621, 'labelsOnTop': True, 'depthCueRange': (0.5, 1), 'silhouetteWidth': 2, 'singleLayerTransparency': True, 'shadowTextureSize': 2048, 'backgroundImage': [None, 1, 2, 1, 0, 0], 'backgroundGradient': [('Chimera default', [(1, 1, 1, 1), (0, 0, 1, 1)], 1), 1, 0, 0], 'depthCue': True, 'highlight': 0, 'scaleFactor': 1.0457239168434, 'angleDependentTransparency': True, 'backgroundMethod': 0}, 'viewerHL': 4, 'cameraMode': 'mono', 'detail': 1.5, 'viewerFog': None, 'viewerBG': None}
      ...
      [
       {
        ...
        'session_volume_id': '6\rH=\tHBe.;\rtw]9/ U\tpA8\x0czjJdTH0wR',
        ...
        'surface_levels': [ 0.34896502547579095, ],
        'surface_model': {
          'active': True,
          'class': 'Model_State',
          ...
          'xform': {
            'class': 'Xform_State',
            'rotation_angle': 139.34036575956344,
            'rotation_axis': ( 0.33595541013486063, 0.7537848051139707, -0.5647498826741009, ),
            'translation': ( 44.999744462726746, 109.20085969504134, 148.88732080509024, ),
            'version': 1,
           },
         },
      ...
      [
       {
        ...
        'representation': 'surface',
        'session_volume_id': ".bvR/t'H&\\ &B%kWk(wJ=*:RBW2\x0bdK74",
        'solid_brightness_factor': 1.0,
        'solid_colors': [
          ( 0.7, 1, 1, 1, ),
          ( 0.7, 1, 1, 1, ),
        ...
        'surface_levels': [ 0.3366405743750274, ],
        'surface_model': {
          'active': True,
          'class': 'Model_State',
          'clip_plane_normal': ( 0.0, 0.0, 0.0, ),
          ...
          'xform': {
            'class': 'Xform_State',
            'rotation_angle': 152.39679488003972,
            'rotation_axis': ( 0.3975944053234705, 0.6819518184041333, -0.613889571690847, ),
            'translation': ( 76.20739508355878, 71.9510071798228, 59.510560030250595, ),
            'version': 1,
           },
         },
        'transparency_depth': 0.5,
      ...
      [
       {
        ...
        'representation': 'surface',
        'session_volume_id': '\'WFEa\x0b|5"}qM38NY7G!NjW\\q#H+\tF}\n@',
        'solid_brightness_factor': 1.0,
        'solid_colors': [
          ( 1.0, 1.0, 1.0, 1, ),
          ( 1.0, 1.0, 1.0, 1, ),
        ...
        'surface_levels': [ 0.7059606396195348, ],
        'surface_model': {
          'active': True,
          'class': 'Model_State',
          'clip_plane_normal': ( 0.0, 0.0, 0.0, ),
          ...
          'xform': {
            'class': 'Xform_State',
            'rotation_angle': 139.85674241699957,
            'rotation_axis': ( 0.33779808990627075, 0.7532146498105001, -0.5644113232089881, ),
            'translation': ( 45.82198605251417, 108.99398735643256, 149.20428587300563, ),
            'version': 1,
           },
         },
        'transparency_depth': 0.5,
      ...
      [
       {
        ...
        'representation': 'surface',
        'session_volume_id': 'n|k7arCJCp<Imc&A5Yw.ZF<A~3clFc\n-',
        'solid_brightness_factor': 1.0,
        'solid_colors': [
          ( 0.7, 0.7, 1, 1, ),
          ( 0.7, 0.7, 1, 1, ),
        ...
        'surface_levels': [ 0.04289696651934128, ],
        'surface_model': {
          'active': True,
          'class': 'Model_State',
          'clip_plane_normal': ( 0.0, 0.0, 0.0, ),
          ...
          'xform': {
            'class': 'Xform_State',
            'rotation_angle': 152.79357908202692,
            'rotation_axis': ( 0.4076004043851545, 0.6696517354675992, -0.6208288520440163, ),
            'translation': ( 76.5082391161551, 72.32758072308005, 59.267575091613594, ),
            'version': 1,
           },
         },
        'transparency_depth': 0.5,
 ...
 volume_dialog_state = \
  {
   ...
   'data_cache_size': '512',
   'focus_volume': '\'WFEa\x0b|5"}qM38NY7G!NjW\\q#H+\tF}\n@',
   'geometry': u'670x383+2562+266',
   'histogram_active_order': [ 2, 0, 1, ],
   'histogram_volumes': [ ".bvR/t'H&\\ &B%kWk(wJ=*:RBW2\x0bdK74", 'n|k7arCJCp<Imc&A5Yw.ZF<A~3clFc\n-', '\'WFEa\x0b|5"}qM38NY7G!NjW\\q#H+\tF}\n@', ],
...
def restoreRemainder():
	...
	xformMap = {0: (((0.37348787572752, 0.69661472413965, -0.6125640642385), 148.8912940597), (63.954218298557, 118.80996515799, 148.37185137574), True)}
