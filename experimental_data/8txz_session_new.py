...
u'At': ((0.458824, 0.309804, 0.270588), 1, u'default'), u'In': ((0.65098, 0.458824, 0.45098), 1, u'default')}
	...
	viewerInfo = {'cameraAttrs': {'center': (78.3255, 57.641, 94.981500002384), 'fieldOfView': 48.655426633719, 'nearFar': (62.004574345849, 44.729659621071), 'ortho': False, 'eyeSeparation': 50.8, 'focal': 94.981500002384}, 'viewerAttrs': {'silhouetteColor': None, 'clipping': False, 'showSilhouette': False, 'showShadows': False, 'viewSize': 14.423099841873, 'labelsOnTop': True, 'depthCueRange': (0.5, 1), 'silhouetteWidth': 2, 'singleLayerTransparency': True, 'shadowTextureSize': 2048, 'backgroundImage': [None, 1, 2, 1, 0, 0], 'backgroundGradient': [('Chimera default', [(1, 1, 1, 1), (0, 0, 1, 1)], 1), 1, 0, 0], 'depthCue': True, 'highlight': 0, 'scaleFactor': 4.8248058314915, 'angleDependentTransparency': True, 'backgroundMethod': 0}, 'viewerHL': 4, 'cameraMode': 'mono', 'detail': 1.5, 'viewerFog': None, 'viewerBG': None}
      ...
      [
       {
        ...
        'session_volume_id': 'vW\'4^o\x0cI6wra{%,oeu%m,iA+"m@}\r,fl',
        ...
        'surface_levels': [ 0.3328173115614571, ],
        'surface_model': {
          'active': True,
          'class': 'Model_State',
          ...
          'xform': {
            'class': 'Xform_State',
            'rotation_angle': 115.36420684863273,
            'rotation_axis': ( -0.07883788399697524, -0.8435507805986018, -0.5312312759979115, ),
            'translation': ( 96.61755357437166, 42.420602154896365, 36.572395017780394, ),
            'version': 1,
           },
         },
      ...
      [
       {
        ...
        'representation': 'surface',
        'session_volume_id': 'k4\n-sfn\x0bj"~|j*\'CU*SA|I_ux`\x0bwzH~s',
        'solid_brightness_factor': 1.0,
        'solid_colors': [
          ( 1, 1, 0.7, 1, ),
          ( 1, 1, 0.7, 1, ),
        ...
        'surface_levels': [ 0.14042570869831572, ],
        'surface_model': {
          'active': True,
          'class': 'Model_State',
          'clip_plane_normal': ( 0.0, 0.0, 0.0, ),
          ...
          'xform': {
            'class': 'Xform_State',
            'rotation_angle': 115.36286667063258,
            'rotation_axis': ( -0.08062896742780844, -0.8437493225960798, -0.5306468225007871, ),
            'translation': ( 155.87014740228366, -18.328670021103104, -41.3162558227097, ),
            'version': 1,
           },
         },
        'transparency_depth': 0.5,
      ...
      [
       {
        ...
        'representation': 'surface',
        'session_volume_id': 'Misi>93I_)HA3IZmDV\\$E@U9d6 McSv)',
        'solid_brightness_factor': 1.0,
        'solid_colors': [
          ( 0.7, 0.7, 1, 1, ),
          ( 0.7, 0.7, 1, 1, ),
        ...
        'surface_levels': [ 0.1379608035475213, ],
        'surface_model': {
          'active': True,
          'class': 'Model_State',
          'clip_plane_normal': ( 0.0, 0.0, 0.0, ),
          ...
          'xform': {
            'class': 'Xform_State',
            'rotation_angle': 115.37480290767775,
            'rotation_axis': ( -0.07969064602400189, -0.8450026392159311, -0.5287910179403471, ),
            'translation': ( 96.63825455348346, 42.38327283169941, 36.62551271143679, ),
            'version': 1,
           },
         },
        'transparency_depth': 0.5,
      ...
      [
       {
        ...
        'representation': 'surface',
        'session_volume_id': ",RTI4?\tO'.&|(97Q^jn\x0b\tV\\x`nt~>\r@,",
        'solid_brightness_factor': 1.0,
        'solid_colors': [
          ( 1.0, 1.0, 1.0, 1, ),
          ( 1.0, 1.0, 1.0, 1, ),
        ...
        'surface_levels': [ 0.5405970227663948, ],
        'surface_model': {
          'active': True,
          'class': 'Model_State',
          'clip_plane_normal': ( 0.0, 0.0, 0.0, ),
 ...
 volume_dialog_state = \
  {
   ...
   'data_cache_size': '512',
   'focus_volume': ",RTI4?\tO'.&|(97Q^jn\x0b\tV\\x`nt~>\r@,",
   'geometry': u'793x511+2829+274',
   'histogram_active_order': [ 1, 0, ],
   'histogram_volumes': [ 'Misi>93I_)HA3IZmDV\\$E@U9d6 McSv)', ",RTI4?\tO'.&|(97Q^jn\x0b\tV\\x`nt~>\r@,", ],
...
def restoreRemainder():
	...
	xformMap = {0: (((-0.080628967427808, -0.84374932259608, -0.53064682250079), 115.36286667063), (155.87014740228, -18.328670021103, -41.31625582271), True)}
