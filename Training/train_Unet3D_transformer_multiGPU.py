...
if __name__ == '__main__':
    ...
    train_loader = PLIDataLoader(train_set, batch_size=batch_size, sampler=train_sampler, drop_last=True)
    valid_loader = PLIDataLoader(valid_set, batch_size=batch_size, sampler=valid_sampler)
